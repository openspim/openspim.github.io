...
Please note that the OpenSPIM plugin's anti-drift requires a [[Pixel Size Calibration|calibrated pixel size]] to function properly. Uncalibrated systems will encounter severe troubles while applying the anti-drift corrections.
