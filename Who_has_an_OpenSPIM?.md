...
= Aachen, Germany =
[[File:IPT.png|300px|thumb|right|OpenSPIM with temperature controlled sample chamber by Fraunhofer IPT]]
* [http://www.ipt.fraunhofer.de/en/Businessunits/LifeSciencesEngineering.html Life Sciences Engineering Business Unit] at the Fraunhofer Institute for Production Technology IPT.
...
= Dresden, Germany =
[[File:X-OpenSPIMs-Tomancak-Lab.jpg|300px|thumb|right|LOCI's L-SPIM, January 22, 2016]]
...
= Madison, WI, USA =
[[File:LOCI-Setup.jpg|300px|thumb|right|LOCI's L-SPIM, January 22, 2016]]

* [http://loci.wisc.edu/ The Laboratory of Optical and Computational Instrumentation (LOCI)] run by [http://loci.wisc.edu/people/kevin-eliceiri Kevin Eliceiri] at the University Wisconsin-Madison. It uses a Coherent Cube laser and a Hamamatsu Orca R^2 camera, being controlled by a 32-bit Windows XP computer.

* The OpenSPIM software was developed in this lab by Johannes Schindelin and Luke Stuyvenberg, and tested and refined with the help of Julie Last and Jayne Squirrel (see the [[People]] page for details), using that setup. The source code is hosted on [https://github.com/openspim/micromanager GitHub].

<br clear="all" />

= Heidelberg, Germany =
[[File:COS HD OpenSPIM 1.JPG|300px|thumb|right|COS Heidelberg OpenSPIM]]
* [http://www.cos.uni-heidelberg.de/index.php/a.maizel?l=_e Maizel] and [http://www.cos.uni-heidelberg.de/index.php/s.lemke?l=_e Lemke] groups at the [http://www.cos.uni-heidelberg.de/?l=_e Center for Organismal Studies] of the Heidelberg University.
* This setup slightly differs from the specifications of OpenSPIM v1.0. In particular we use a  [http://www.cobolt.se/mld488nm.html Cobolt laser], Nikon lenses and an [http://www.hamamatsucameras.com/flash4/l Orca4], the whole running under Windows7 Pro.
...
[[File:4arm system.jpg|300px|thumb|right|Fig. 1 Four-arm OpenSPIM]]

* The [http://www.damtp.cam.ac.uk/user/gold/?l=_e Goldstein] group in the [http://www.damtp.cam.ac.uk/?l=_e Department of Applied Mathematics and Theoretical Physics] at the University of Cambridge.
We recently extended to a 4-armed system (Fig. 1): 
* 4 port sample chamber: [[Media:4_port_chamber.pdf]]
* dual sided illumination with Vortran VersaLase multiple wavelength laser module (488, 561, 647 nm).
* dual sided detection with 2 Photometrics [http://www.photometrics.com/products/ccdcams/coolsnap-myo.php:l  Coolsnap Myo].
* We included a Thorlabs [http://www.thorlabs.de/NewGroupPage9.cfm?ObjectGroup_ID=927?l shutter] in the beam path.
* For brightfield illumination during sample positioning we use a lamp that is temporarily inserted in one of the filter holders (Fig. 2): [[Media:LED tube light.pdf]]
...
For this we added a lamp that switches on when the laser shutter closes. The LED driver is triggered by the laser shutter controller via a TTL inverter (Fig. 4).
* To improve the robustness of the sample positioning we designed 3D printable sample holders (Fig. 5).

See also [https://www.hackster.io/steph2/dual-view-imaging-in-a-custom-built-light-sheet-microscope-e4502f Dual-view imaging on hackster.io]

<gallery widths=225px>
File:20170621_114544.jpg|300px|thumb|right|Fig. 2 LED tube light for brightfield
File:adjustable_foot_smaller.jpg|300px|thumb|right|Fig. 3 Adjustable foot to align detection arm
File:Illumination.png|300px|thumb|right|Fig. 4 Schematic for illumination between acquisitions
File:sample_holder.png|300px|thumb|right|Fig. 5 3D-printed sample holder
</gallery>
...
* The Light Microscopy Facility at the [http://www.http://www2.mrc-lmb.cam.ac.uk/ Medical Research Council's Laboratory of Molecular Biology]
* Our system features two-sided excitation with adjustable focus of the sheet lenses (Olympus 5x/0.15 air MPLFLN5X) which sit outside the imaging chamber to cope with different refractive indices.
* 4 laser lines - combined in a separate laser bed and fed into a fibre (405nm & 640nm: both Coherent Cube; 488nm & 561nm: both Coherent Sapphire) 
* The imaging chamber can be heated to e.g. 37C for live cell imaging purposes.
...
= Melbourne, Australia =
[[File:Petrou SPIM.jpg|300px|thumb|right|OpenSPIM system using the Picard high-resolution stage and an Andor Neo camera in the Petrou Lab, Melbourne, Australia.]]
* The Petrou group at the [http://http://www.florey.edu.au/research/ion-channels-disease?l=_e Florey Institute] the [http://www.cfne.unimelb.edu.au/research-laboratories/neurobiology/?i=_e Centre for Neural Engineering] and the  [http://www.cibf.edu.au//?i=_e Centre for Integrated Brain Function] at the University of Melbourne. 
...
= Berlin, Germany =
[[File:OpenSPIM_Berlin_top_view.png|300px|thumb|right|OpenSPIM at Humboldt University Berlin]]
* The Scholtz group at the [http://www2.hu-berlin.de/biologie/zoologie/carsten_wolff/carsten.html?l=_e Humboldt University Berlin]. 
...
[[File:T-SPIM_chamber.png|300px|thumb|right|T-SPIM chamber, designed by Pete Pitrone and build at the workshop of the MPI CBG Dresden. ]]

<br clear="all" />

= Exeter, UK =
[[File:OpenSPIM_System.jpg|300px|thumb|right|OpenSPIM at the University of Exeter.]]
* The [http://lifesciences.exeter.ac.uk/ College of Life and Environmental Sciences] in association with the [http://emps.exeter.ac.uk/ College of Engineering, Mathematics and Physical Sciences].
...
= Oulu, Finland =
[[File:OpenSPIM_Oulu_top_view.jpg|300px|thumb|right|OpenSPIM at the University of Oulu.]]
* The [http://www.oulu.fi/biocenter/lm Light Microscopy Core Facility, at the Biocenter Oulu and the University of Oulu].
...
= Indianapolis, IN, USA =
[[File:OpenSPIM_IUSM_LCDs.jpg|300px|thumb|right|OpenSPIM at IUSM.]]
[[File:OpenSPIM_IUSM_Chamber_illuminated.jpg|300px|thumb|right|IU OpenSPIM chamber with oblique illumination.]]
* The [http://web.medicine.iupui.edu/icbm/ Indiana Center for Biological Microscopy at Indiana University School of Medicine].
...
* To support more fluorophores we incorporated five laser lines (442, 488, 514, 568 and 647 nm) with AOTF modulation controlled via an [https://www.arduino.cc Arduino] based [http://www.ti.com/product/tlv5618a 6 channel  DAC].  Emission wavelength filtering is with a workhorse [http://www.sutter.com/IMAGING/lambda102.html Sutter Lambda 10-2].  Multichannel acquisition is fully controlled (AOTF, filter wheels, etc) by a custom version of the SPIM Acquisition Plugin and derivations of the Arduino device adapter for MicroManager.  To assess laser power, a motorized mirror and ThorLabs detector have been incorporated prior to beam shaping.
*To support live imaging we have incorporated a perfusion and temperature control system into the standard L-SPIM chamber(no drilling etc.) built with off-the-shelf components (shout-out to [http://www.adafruit.com Adafruit] and [http://www.sparkfun.com Sparkfun]).  It is Arduino based and relies on a bunch of pumps and thermistors.  MicroManager integration and a CO2 loop is in the works (anyone with experience implementing [http://www.mouser.com/ProductDetail/Amphenol-Advanced-Sensors/T6615-50K/?qs=sGAEpiMZZMvhkhGuTKDegrl2ezYd2qTk amphenol CO2 sensors]?).
* Our OpenSPIM is fully contained to simplify laser safety. To facilitate alignment and sample positioning a secondary camera driven by a [https://www.raspberrypi.org RaspberryPi] provides a live image of the chamber with oblique RGB LED illumination from an Arduino and PWM via the 16 channel [http://playground.arduino.cc/Learning/TLC5940 TLC5940].
...
[[File:WarsawSPIM doubleIllum.jpg|300px|thumb|right|Cleared-tissue imaging SPIM at the Nencki Institute.]]
...
* beam height is raised to 65 mm, mainly for compability with the argon laser
* we have demonstrated whole mouse and rat brain imaging (see [http://www.nature.com/articles/srep28209/ paper])
...
[[File:Cylindrical lens and corner mirror2.jpg|300px|thumb|right|OpenSPIM HMRI/UoN glamour shot]]
...
* Controlled via Micromanager, with 3D dataprocessing performed with FIJI, Terastitcher and Vaa3D using the UoN HPC Cluster
...
[[File:OpenSPIM Telford-Lab UCL.png|300px|thumb|right|OpenSPIM with two lasers (VersaLase: 488, 561) and dual sided illumination running in the the Max Telford Lab (UCL, UK)]]
