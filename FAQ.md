...
The ideal way, of course, is to add a Wiki page to this Wiki. However, if you want to work on a macro together with somebody else, the easiest way is to use kind of a [http://demo.firepad.io/#openspim shared clipboard].
...
At the time of writing, we know that the Hammamatsu camera works with both Windows XP and Windows 7 using the [http://www.dcamapi.com/ DCAM driver].
...
# Follow steps 1-3 above. Additionally install [http://eclipse.org/m2e/ m2e] for Maven support in Eclipse .
