==Projects==
[[File:Fusion.ogv|200 px|thumb|Fusion of 12 registered views]] [[File:Deconvolution.ogv|200 px|thumb|Deconvolution of 12 registered views]]
...
====Overnight time-lapse imaging of living, 4-days-old spheroids (&oslash; &asymp; 50 µm) on Zeiss Lightsheet Z.1====

* '''Sample preparation'''
  
H2B-GFP cells were additionally labelled with the live-dye SiR-tubulin ([http://www.nature.com/nmeth/journal/v11/n7/full/nmeth.2972.html Lukinavičius et al. 2014]). They were embedded as single cells in Matrigel and injected into chambers made of either 1 % Gelrite or 1.5 % agarose. We incubated the chambers and let the cells proliferate and form small spheroids for four days.
...
[[File:sample_mounted.png|200px|thumb|sample holder]]
[[File:samplemounting.png|200px|thumb|scheme for sample orientation]]
...
2. A tube was fixed to a metal-based sample holder with adhesive tape as shown in the picture on right.<br>
...
'''Parameters for laser ablation<br>[[File:Spim_ablation.ogv|200px|thumb|right|laser ablation of the zebrafish brain expressing a fluorescent membrane marker]]
*Laser power: <600mW
*Wave length: 920 nm
*Duration: <2 sec

[[File:Static_and_scanning_LS.png|600px|centre|thumb|There are two different types of light sheet; conventional static light sheet created by cylindrical lens and scanning light sheet. The Myers' SPIM has the latter one. Illumination without scanning gives size limitation of the LS in Y direction.]]
[[File:Different_thickness_of_LS.png|800px|left|thumb|By changing N.A. of excitation lens changing thickness of light sheet is available. Thiner light sheet was applied to make a well-confined laser area.<Refer to this paper from Betzig's group: Gao et al., Nature Protocols 9, 1083–1101 (2014)>]]<br><br><br><br><br><br><br><br><br><br><br><br><br>
...
[[File:temporal_color.ogv|200px|thumb|right|development of the central nervous system in zebrafish larvae]]
[[File:color_column.jpg|200px|thumb|right|color spectrum of the movie, showing depth of the each fluorescent beads. 1 frame=1µm]]
'''Sample Preparation
...
To show the depth of each Z stack, temporal colour code will be useful
...
*LUT = Spectrum
'''Time Stamp
To show each time points on                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           9time-lapse data, time stamp is required.
...
[[File:Schema1.jpg|500px]]  Initial setup idea

====making of the canal====

=====first attempt=====

[[File:Attempt1.jpg|400px|canal preparation]]
making of the canal

[[File:Attempt1_suite.jpg|400px|canal preparation]]
...
=====second attempt=====
[[File:Attempt2.jpg|300px|canal preparation]]
making of the canal

[[File:Attempt2_suite.jpg|400px|canal preparation]]
after the removal of the plunger
...
[[File:sucker.jpg|400px]]

Not so good, a very slight movement of the seringe piston is equivalent to the all volume of the capillary. I think it can be master but will require quit a lot of practice


====That being said====
If you have at your disposal the computers, the softwares and the people that knows how to use them why bother, just go full computer sience approach
...
To investigate vein structure we used Zeiss LZ.1 Light sheet microscope. In order to image whole fish, image was acquired with 5 separate (semi-manually selected) tiles function (Fig A), 20 x obj lens, two sides illumination, one side detection and multiview function - 6 angles (Fig B). 
Data Processing Procedure: 42GB data was analysed with use of Reconstruction of Multiview Microscopy Data (ImageJ plugin developed by Stephan Preibisch). For registation we used beads based system followed by deconvolution and fusion (fiji plugin fiusion). For 3D animation we use Fiji plugin 3D multiview. Because of problems with huge data handling size of the image was reduced 2x.

[[File:sample.png|500px]]
...
[[File:Movie.ogv|640px]]

====Description here====

[[File:Movie2.ogv|640px]]

====Description here====

[[File:Movie heart.ogv|640px]]
