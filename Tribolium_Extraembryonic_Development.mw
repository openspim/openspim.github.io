=Background=
[[File:Tribolium.png|160px|thumb|right|Fig 1. The red flour beetle ''Tribolium castaneum'']]
...
[[File:koelzer_etal_2014.png|160px|thumb|right|Fig 2. left column: G12424 "serosa line". right column: G04609 "heart line" (modified from Koelzer et al. 2014)]]


In order to study these morphogenetic process in ''Tribolium'', our lab characterised several [http://www.geku-base.uni-goettingen.de/ GEKU] enhancer trap lines [[#Koelzer_etal_2014|(Koelzer et al. 2014)]] [Figure 2]. One of these lines specifically expresses EGFP in the serosa (G12424 or "serosa" line) . A second line marks, among other tissues, precursor cells of the heart (G04609 or "heart" line). Enhancer trap lines are of particular interest for studies of the extramembryonic membranes, because it is very difficult to stain late embryonic stages with, for example, antibodies, due to the formation of cuticle. Also, these lines allow live imaging of the development of particular tissues in vivo.
...
[[File:TP35_5views.png|160|thumb|right|Fig 4. Maximum intensity projection of five different angles at time point 35]]
[[File:Bead_based_registration.png|160|thumb|right|Fig 5. Screenshots of BigDataViewer illustrating poor bead-based multiview registration]]
[[File:Segmentation_based_registration.png|160|thumb|right|Fig 6. Segmentation based registration worked better for this dataset]]



Data analysis was performed using Fiji plugins [http://fiji.sc/Multiview-Reconstruction Multiview-Reconstruction] and [http://fiji.sc/BigDataViewer BigDataViewer]. Initial analysis was done on time point 35, which would later serve as a reference time point for the whole time lapse. As a first step, files were converted from .czi to .tif, and maximum intensity projections were made for each of the five views [Fig. 4]. 
