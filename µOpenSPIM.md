...
3.  CLick the *START* button (top left). In the new window multiple µManager configuration files can be added,removed and selected. Click “Add .cfg file” and select your working µManager configration file ending with .cfg. Then click the "OK" button. After loading the hardware µManager should now be ready for use.
