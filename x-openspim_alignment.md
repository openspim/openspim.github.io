...
-   initially align the beam path along the rails
-   visualize and tune the beam within the field of view of one or two cameras 
-   fine align the created light-sheet on the sample (final step).
