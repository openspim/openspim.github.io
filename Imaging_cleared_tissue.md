...
* For a summary of various clearing techniques, and detailed instructions for performing CLARITY (excellent for neural tissue), please consult the following manual compiled by the 3D Tissue Clearing and Lightsheet Microscopy Facility (HMRI/UoN) [[Media:3D_Tissue_Clearing_Handbook_3rd_Ed.pdf]]

* [http://clarityresourcecenter.org/ CLARITY resource center]

* [https://idisco.info/ iDISCO method]
...
* glycerol in the right concentration (80% has been used for CLARITY by [http://eneuro.org/content/2/3/ENEURO.0022-15.2015 Epp et al.])
* microscopy immersion oil
* the authors of [http://www.sciencedirect.com/science/article/pii/S0092867414004188 CUBIC paper] recommend a a 1:1 mixture of silicon oil TSF4300 (Momentive Performance Materials, RI = 1.498) and mineral oil (Sigma-Aldrich, RI = 1.467).
...
For confocal or two-photon microscopy, a chamber with depth equal to the sample thickness should be be used. For designs see: [http://wiki.claritytechniques.org/index.php/Sample_Mounting#Whole_brain_mounting_for_confocal_imaging CLARITYT Wiki], [https://idiscodotinfo.files.wordpress.com/2015/03/idisco-whole-mount-staining-bench-protocol-may-2016.pdf iDISCO protocol], [http://openspim.org/images/a/a8/3D_Tissue_Clearing_Handbook_3rd_Ed.pdf HMRI/UoN handbook]
...
[[File:Holder.PNG|240px|thumb|left|Glass slide holder used in the SPIM for brains setup [http://www.nature.com/articles/srep28209]. This holder can be mounted on the stage arm using a M6 screw. Glass slide can be mounted with a M3 nylon or nylon-tipped screw. ]]
