...
##### Objects needed
  ...
  - 1x [POLARIS-K1](https://www.thorlabs.com/thorProduct.cfm?partNumber=POLARIS-K1) 1" mirror mount with mirror installed
  - 1x 25 mm tall optical post/spacer with M4 thru tap through the
    center
  - 1x ThorLabs part # [SD1](https://www.thorlabs.com/thorProduct.cfm?partNumber=SD1) - M4 to M6 adapter
...
<b style="color:#FF0000"> From here on out till the completion of the installation of the OpenSPIM the furthest threaded hole juxtaposed in the opposite corner to the 1" mirror post will be called A1.</b>

{% include video id="IU9aeoVezRY" width="400" height="243" caption="Assembly large mirror mount to optical breadboard" %}

<table>
<tr>
<td>{% include image src="00a.jpg" width="70%" caption="" %}</td>
<td>{% include image src="01a.jpg" width="70%" caption="" %}</td>
<td>{% include image src="02a.jpg" width="70%" caption="" %}</td>
</tr>
<tr>
<td>{% include image src="Real_00.jpg" width="70%" caption="" %}</td>
<td>{% include image src="Real_01.jpg" width="70%" caption="" %}</td>
<td>{% include image src="Real_02.jpg" width="70%" caption="" %}</td>
</tr>
</table>
...
{% include video id="2Yq3PTbr9sU" width="400" height="243" caption="Installation of laser with heatsink on optical breadboard" %}

<table>
<tr>
<td>{% include image src="03a.jpg" width="70%" caption="" %}</td>
<td>{% include image src="Real_03.jpg" width="70%" caption="" %}</td>
</tr>
</table>
...
{% include video id="rEyWhqJNP90" width="400" height="243" caption="Putting the laser on the heatsink" %}

<table>
<tr>
<td>{% include image src="04a.jpg" width="70%" caption="" %}</td>
<td>{% include image src="Real_04.jpg" width="70%" caption="" %}</td>
</tr>
</table>
...
##### Objects needed
  ...
  - 1x ThorLabs part # [RLA075/M](https://www.thorlabs.de/thorProduct.cfm?partNumber=RLA075/M) 75 mm dovetail rail
  - 2x ThorLabs part # [RLA150/M](https://www.thorlabs.de/thorProduct.cfm?partNumber=RLA150/M) 150 mm dovetail rails
  - 1x ThorLabs part # [RLA300/M](https://www.thorlabs.de/thorProduct.cfm?partNumber=RLA300/M) 300 mm dovetail rail
...
{% include video id="v6zzWuyd0JE" width="400" height="243" caption="Assembly of dovetail rails to optical breadboard" %}

<table>
<tr>
<td>{% include image src="05a.jpg" width="70%" caption="" %}</td>
<td>{% include image src="Real_05.jpg" width="70%" caption="" %}</td>
</tr>
</table>
...
{% include video id="PrXBnJcvaqI" width="400" height="243" caption="Installation of small mirror assemblies to dovetail rail system" %}

<table>
<tr>
<td>{% include image src="06a.jpg" width="70%" caption="" %}</td>
<td>{% include image src="Real_06.jpg" width="70%" caption="" %}</td>
</tr>
</table>
...
{% include video id="blgEtuH6pN0" width="400" height="243" caption="Installation of SPIM chamber assembly to dovetail rail system" %}

<table>
<tr>
<td>{% include image src="07a.jpg" width="70%" caption="" %}</td>
<td>{% include image src="Real_07.jpg" width="70%" caption="" %}</td>
</tr>
</table>

## [Next step](Alignment_of_laser)
